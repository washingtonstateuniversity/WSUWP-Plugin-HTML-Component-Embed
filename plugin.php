...
Text Domain: html-component-embed
*/
...
if ( version_compare( PHP_VERSION, '5.3', '<' ) ) {
	...
	"echo '<div class=\"error\"><p>" . __( 'HTML Component Embed requires PHP 5.3 to function properly. Please upgrade PHP or deactivate the plugin.', 'html-component-embed' ) . "</p></div>';" ) );
	return;
} else {
